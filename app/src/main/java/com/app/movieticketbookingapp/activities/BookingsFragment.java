...
import com.app.movieticketbookingapp.adapters.AdminBookingsDisplayAdapter;
...
public class BookingsFragment extends Fragment {
    ...
    private AdminBookingsDisplayAdapter adapter;

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.activity_bookings_fragment, container, false);
        ...
        adapter = new AdminBookingsDisplayAdapter(bookingList, new AdminBookingsDisplayAdapter.OnBookingActionListener() {
            @Override
            public void onAddClick(Booking booking) {
                // Fetch movie data, then show update dialog
    ...
    private void fetchAllActiveBookings() {
                ...
                .setPositiveButton("Yes", (dialog, which) -> {
                    db.collection("bookings").document(booking.getId()).delete()
                            .addOnSuccessListener(unused -> {
                                // Return tickets to movie count
                                db.collection("movies").document(booking.getMovieDocId())
                                        .update("totalTickets", com.google.firebase.firestore.FieldValue.increment(booking.getQuantity()))
